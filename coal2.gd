...
func _physics_process(delta):
	var x_movement = Input.get_action_strength("move_d") - Input.get_action_strength("move_a")
	var y_movement = Input.get_action_strength("move_s") - Input.get_action_strength("move_w")
